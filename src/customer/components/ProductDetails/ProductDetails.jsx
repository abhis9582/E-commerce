            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                    ...
                    <p className="ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500">3740 reviews</p>
                </div>
              </div>
                ...
                <Grid container spacing={7}>
                    ...
                    <Grid item xs={5}>
                        ...
                        <div className="flex items-center space-x-3">
                            ...
                            <p className="opacity-60">59854 Ratings</p>
                        </div>
                        <Box className="mt-5 space-y-2">
                            ...
                            <Grid container gap={2}>
                                ...
                                <Grid item xs={7}>
                                    ...
                                    variant="determinate" value={25} color="secondary"
                                    />
                                </Grid>
